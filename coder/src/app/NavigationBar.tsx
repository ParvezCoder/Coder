      ...
      <header className="text-gray-600 body-font bg-black ">
        <div className="container mx-auto flex flex-wrap  flex-col md:flex-row items-center">
          ...
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center pr-6 text-white">
            <a className="mr-5 hover:text-gray-900 rounded hover:bg-white p-1 px-3 hover:text-black">Home</a>
            <a className="mr-5 hover:text-gray-900 rounded hover:bg-white p-1 px-3 hover:text-black">About</a>
            <a className="mr-5 hover:text-gray-900 rounded hover:bg-white p-1 px-3 hover:text-black">Projects</a>
            <a className="mr-5 hover:text-gray-900 rounded hover:bg-white p-1 px-3 hover:text-black">Download Cv</a>
          ...
          <div className="grid lg:grid-cols-3 items-center">
            <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
              ...
              <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                ...
                <p className="text-sm text-gray-600 mt-2">info@ReXon.com</p>
              </div>
              <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
        ...
        <footer className="bg-black py-5 font-sans tracking-wide">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-base">info@ReXon.com</p>
